...
describe('settling bills test', () => {
    ...
    //     // cy.get('[data-testid="transaction-checkbox"]').invoke('attr','checked').should('contain','false');
    //     cy.get('[data-testid="transaction-checkbox-label"]').should('exist').click();
    //     // cy.get('[data-testid="transaction-checkbox"]').invoke('attr','checked').should('contain','true');
    //     // cy.get('[data-testid="transaction-checkbox"]').check();
    //     // cy.get('[data-testid="transaction-checkbox"]').invoke('attr','checked').should('contain','false');
    //     // cy.get('[data-testid="transaction-checkbox"]').check();
    //     // cy.get('[data-testid="transaction-checkbox"]').invoke('attr','checked').should('contain','true');
    ...
    //     // cy.get('[data-testid="transaction-checkbox"]').invoke('attr','checked').should('contain','false');
    //     // cy.get('[data-testid="transaction-checkbox"]').check();
    //     // cy.get('[data-testid="transaction-chexkbox"]').invoke('attr','checked').should('contain','true');
